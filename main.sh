...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " WELCOME TO MANDIRI NETWORK SCRIPT ${YELLOW}(${NC}${green}Stable Edition${NC}${YELLOW})${NC}"
echo -e " PROSES PENGECEKAN IP ADDRESS ANDA !!"
echo -e "${purple}----------------------------------------------------------${NC}"
echo -e " ›AUTHOR : ${green}MANDIRI NETWORK <® ${NC}${YELLOW}(${NC}${green}V 3.2${NC}${YELLOW})${NC}"
echo -e " ›TEAM 🅥🅝: MANDIRI NETWORK ${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Regersays69/VVIP/main/"
...
clear
izinsc="https://raw.githubusercontent.com/Regersays69/permision/main/reg"
# USERNAME
rm -f /usr/bin/user
...
<code>────────────────────</code>
<b> MANDIRI NETWORK VVIP SCRIPT  </b>
<code>────────────────────</code>
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ SCRIPT BY MANDIRI NETWORK ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
echo "TOLOL"
